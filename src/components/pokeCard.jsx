...
const PokeCard = ({ url, name }) => {
    ...
    const border = `border-${pokemon?.tyype}`;
        ...
        <>
            {pokemon && (
                ...
                >
                    ...
                    <div className={`w-full f-6 flex items-center justify-center content-center`}>
                        <div className={`box-border relative flex w-full h-[5.5rem] basis justify-center`}>
